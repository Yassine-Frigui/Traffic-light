...
% Chapter title formatting - centered at top
\titleformat{\chapter}[display]
{\normalfont\huge\bfseries\color{primaryblue}\centering}
...
\begin{titlepage}
    ...
    % ============================================
    \begin{center}
        \includegraphics[width=5cm]{logo_iTeam.jpg}
    \end{center}
    ...
    \begin{tabular}{rl}
        \textbf{Réalisé par :} & Yassine Frigui {&&} \\
                               & Mohammed Aziz Dridi \\
        \textbf{Encadré par :} & Iteam University \\
        \textbf{Membres du jury} & Noussaiba Jaafar \\
                                & Salah Hachani \\
        \textbf{Filière :} & Tronc Commun \\
...
Ce rapport présente le travail réalisé par notre binôme dans le cadre du projet semestriel de l'année universitaire 2025-2026 à \textbf{Iteam University}. Ce projet s'inscrit dans le module \textbf{Projet Semestriel}, enseigné par \textbf{Dr. Ghabri Afef}, et vise à mettre en pratique les compétences acquises en développement logiciel, architecture système, et déploiement d'applications web.
...
% Page de plan du chapitre 1
\newpage
\vspace*{\fill}
\begin{center}
{\Huge\textbf{\color{primaryblue}Plan du Chapitre 1}}
\end{center}
\vspace{1cm}
\begin{itemize}[leftmargin=2cm, itemsep=1em]
    \item \Large\textbf{Organisme d'Accueil}
    \item \Large\textbf{Étude et Analyse}
    \item \Large\textbf{Présentation Générale}
    \item \Large\textbf{Conclusion du Chapitre}
\end{itemize}
\vspace*{\fill}
\newpage
...
\begin{figure}[H]
    ...
    \caption{Logo d'Université "Iteam University"}
\end{figure}

Ce projet semestriel a été réalisé dans le cadre de notre formation académique à \textbf{Iteam University}, au sein de la filière \textbf{Tronc Commun}. Le projet s'inscrit dans le module \textbf{Projet Semestriel}, enseigné par \textbf{Dr. Ghabri Afef}, dont l'objectif est de mettre en pratique les compétences acquises en développement web, programmation système, et conception d'architectures logicielles distribuées.
...
% Page de plan du chapitre 2
\newpage
\vspace*{\fill}
\begin{center}
{\Huge\textbf{\color{primaryblue}Plan du Chapitre 2}}
\end{center}
\vspace{1cm}
\begin{itemize}[leftmargin=2cm, itemsep=1em]
    \item \Large\textbf{Analyse des Besoins}
    \item \Large\textbf{Environnement de Travail}
    \item \Large\textbf{Architecture Globale}
    \item \Large\textbf{Conclusion du Chapitre}
\end{itemize}
\vspace*{\fill}
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/vscode.jpeg}
    \caption{VSCode}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{github.png}
    \caption{Logo Github}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/nide.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/react_logo.png}
    \caption{Logo React}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{three_js_logo.png}
    \caption{Logo Three Js}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/Vite.jpeg}
    \caption{Logo Vite}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/python.jpeg}
    \caption{Logo Python}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/aiohttp.png}
    \caption{Logo aiohttp}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/netlify.png}
    \caption{Logo Netlify}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/render.png}
    \caption{Logo Render}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=3cm]{logos/actions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{diag_traffic_light.png}
...
% Page de plan du chapitre 3
\newpage
\vspace*{\fill}
\begin{center}
{\Huge\textbf{\color{primaryblue}Plan du Chapitre 3}}
\end{center}
\vspace{1cm}
\begin{itemize}[leftmargin=2cm, itemsep=1em]
    \item \Large\textbf{Architecture Détaillée}
    \item \Large\textbf{Implémentation Frontend}
    \item \Large\textbf{Implémentation Backend}
    \item \Large\textbf{Sécurité et Performance}
    \item \Large\textbf{Déploiement}
    \item \Large\textbf{Conclusion du Chapitre}
\end{itemize}
\vspace*{\fill}
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{diag_sequence_traf.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm ,height =24cm]{diag_frontend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{diag_de_déploiement.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{config_net.png}
...
# Build Command: pip install -r requirements.txt (contient les librairies)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{rain.png}
    
    \caption{INTERSECTION PLUVIEUSE}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{desert.png}}
    
    \caption{INTERSECTION DÉSERTIQUE}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{snow.png}
    
    \caption{INTERSECTION ENNEIGÉE}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{metro.png}
    
    \caption{INTERSECTION MÉTROPOLITAINE}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm,height=15cm]{HUD.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{language selection.png}
  
    \caption{Sélectionneur des langues}
\end{figure}
L'interface utilisateur a été conçue pour être intuitive et multilingue. Le système prend en charge trois langues (anglais, français, arabe) avec un sélecteur de langue intégré permettant aux utilisateurs de basculer dynamiquement entre les langues. Cette fonctionnalité améliore l'accessibilité et l'expérience utilisateur pour un public international.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm, height =14cm]{map_selection.png}
...
Le système développé répond pleinement aux objectifs fixés en début de projet : accessibilité web, visualisation 3D interactive, architecture distribuée moderne, communication temps réel, et déploiement en production. Les compétences acquises durant ce projet (développement full-stack, programmation asynchrone, rendu 3D, déploiement cloud) constituent un atout majeur pour la suite du parcours académique et professionnel.
...
% Page de plan des annexes
\newpage
\vspace*{\fill}
\begin{center}
{\Huge\textbf{\color{primaryblue}Plan des Annexes}}
\end{center}
\vspace{1cm}
\begin{itemize}[leftmargin=2cm, itemsep=1em]
    \item \Large\textbf{Code Source}
    \item \Large\textbf{Liens de Déploiement}
    \item \Large\textbf{Statistiques du Projet}
\end{itemize}
\vspace*{\fill}
\newpage
